              ...
              <div className="flex flex-col items-center gap-5 text-center max-w-xl mx-auto p-6 rounded-lg bg-green/20 dark:bg-white/5">
                <div className="flex">
                  ...
                  <h5 className="text-green dark:text-green">
                    Harika!!! Mesajınız başarıyla gönderildi. En kısa sürede
                ...
                <div className="flex flex-col md:flex md:flex-row gap-6">
                  <div className="w-full">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                    >
                      <option value="design & branding">Özel Modelleme</option>
                      <option value="Ecommerce">Hazır Koleksiyonlar</option>
                      <option value="Specialist">Teknik Destek</option>
                    </select>
                  </div>
                  <div className="w-full">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                    >
                      <option value="">Bütçenizi seçin</option>
