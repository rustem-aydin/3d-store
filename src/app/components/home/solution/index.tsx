      ...
      <div className="2xl:py-20 py-11">
        <div className="container">
          ...
          >
            <motion.div
              {...bottomAnimation}
              className="flex flex-col gap-6 items-start md:max-w-3xl mx-auto"
            >
              <div className="flex flex-col gap-3 items-start text-start">
                <h2 className="text-3xl md:text-5xl dark:text-dark_black">
                  <TextGenerateEffect words="Projeniz için doğru" />
                  <TextGenerateEffect
                    words="dijital varlıklar"
                    delay={1}
                    className="italic font-normal instrument-font"
                  />
                </h2>
                <p className="dark:text-dark_black">
                  Hayalinizdeki dünyayı inşa etmek için ihtiyacınız olan her şey
                  burada. Yüksek kaliteli 3D modellerimizle projelerinizi
                  gerçeğe dönüştürün ve izleyicilerinizi etkileyin.
                </p>
              </div>
              <Link
                href="/#models"
