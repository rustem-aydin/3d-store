    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          // 🔥 FULLSCREEN
          fullscreen && "inset-0 w-screen h-screen max-w-none rounded-none p-0",
      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className={cn(
              "ring-offset-background focus:ring-ring absolute z-50 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none",
              fullscreen ? "top-4 right-4" : "top-4 right-4"
            )}
          >
            <XIcon />
